...
//
//  -----------
//  • I was not writing function to access top of the stack coz its useless in caze of my implementation.
//  • I was not writing function to reset the stack for the same reason. Stacks is cleared at the end of program.
//  • No memory leaks!
//
